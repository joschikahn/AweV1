...
namespace AweV1.Migrations
{
    ...
    [Migration("20200716100706_Test156156")]
    partial class Test156156
    {
            ...
            modelBuilder.Entity("AweV1.Models.Thesis", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Bachelor = true, ContentVal = 5, ContentWt = 30, Description = "Wahnsinns Arbeit", DifficultyVal = 5, DifficultyWt = 5, Email = "joschikahn@web.de", Evaluation = "war ganz ok", Filing = new DateTime(2020, 7, 16, 12, 7, 5, 822, DateTimeKind.Local), Grade = 1, LastModified = new DateTime(2020, 7, 16, 12, 7, 5, 822, DateTimeKind.Local), LayoutVal = 5, LayoutWt = 15, LiteratureVal = 5, LiteratureWt = 10, Master = true, NoveltyVal = 5, NoveltyWt = 10, Registration = new DateTime(2020, 7, 16, 12, 7, 5, 822, DateTimeKind.Local), RichnessVal = 5, RichnessWt = 10, Status = 3, Strengths = "Alles Super", StructureVal = 5, StructureWt = 10, StudentFirstName = "Tschoschi", StudentID = "2278467", StudentLastName = "Hamburger", StyleVal = 5, StyleWt = 10, Summary = "Es geht um Omni Channels", SupervisorId = 1, Title = "Omni Channel Retail", Type = 0, Weaknesses = "Weak was?" }
                    );
                });
